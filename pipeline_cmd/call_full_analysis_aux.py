...
from scripts.call_Optknock import (full_knock_out_analysis, \
...
def main_whole_analysis(argv):
    ...
    model.remove_reactions(['ACGS']) # TODO: delete this line in final version
    argex = model.reactions.EX_arg__L_e # TODO: delete this line in final version
    argex.lower_bound = -0.2594 # TODO: delete this line in final version
